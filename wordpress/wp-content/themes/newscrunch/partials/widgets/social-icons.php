...
class Newscrunch_Social_Icon_Widget_Controller extends WP_Widget {
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ])){ $title = $instance[ 'title' ]; } else { $title = 'Widget Title' ;}
		//facebook
		...
		<p>
			...
			<!-- Twitter Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'twitter_link' )); ?>">Twitter</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'twitter_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'twitter_follow' )); ?>" type="text" value="<?php if($twitter_follow) echo esc_attr( $twitter_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
			...
			<!-- Facebook Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'facebook_link' )); ?>">Facebook</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'facebook_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'facebook_follow' )); ?>" type="text" value="<?php if($facebook_follow) echo esc_attr( $facebook_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
			...
			<!-- Instagram Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'instagram_link' )); ?>">Instagram</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'instagram_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'instagram_follow' )); ?>" type="text" value="<?php if($instagram_follow) echo esc_attr( $instagram_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
			...
			<!-- Youtube Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'youtube_link' )); ?>">Youtube</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'youtube_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'youtube_follow' )); ?>" type="text" value="<?php if($youtube_follow) echo esc_attr( $youtube_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
			...
			<!-- Lindedin Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'linkedin_link' )); ?>">LinkedIn</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'linkedin_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'linkedin_follow' )); ?>" type="text" value="<?php if($linkedin_follow) echo esc_attr( $linkedin_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
			...
			<!-- Skype Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'skype_link' )); ?>">Skype</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'skype_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'skype_follow' )); ?>" type="text" value="<?php if($skype_follow) echo esc_attr( $skype_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
			...
			<!-- Vimeo Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'vimeo_link' )); ?>">Vimeo</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'vimeo_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'vimeo_follow' )); ?>" type="text" value="<?php if($vimeo_follow) echo esc_attr( $vimeo_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
			...
			<!-- Dribble Link -->
			<h4 for="<?php echo esc_attr($this->get_field_id( 'dribble_link' )); ?>">Dribble</h4>
			...
			<input class="widefat newscrunch-widget-social" id="<?php echo esc_attr($this->get_field_id( 'dribble_follow' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'dribble_follow' )); ?>" type="text" value="<?php if($dribble_follow) echo esc_attr( $dribble_follow ); ?>" placeholder="<?php echo esc_attr( 'Followers','newscrunch' ); ?>"/>
