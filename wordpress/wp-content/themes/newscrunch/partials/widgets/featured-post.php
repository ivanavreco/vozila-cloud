                                    ...
                                    <div class="spnc-entry-content">
                                        <div class="spnc-footer-meta spnc-entry-meta">
                                            ...
                                            <span class="spnc-comment-links">
                                                ...
                                                <a <?php if (is_rtl()) { echo 'dir="rtl"';} ?> href="<?php the_permalink(); ?>#respond" title="<?php esc_attr_e('Number of Comments','newscrunch'); ?>"><?php echo esc_html(get_comments_number()); echo' '; echo esc_html__('Comments','newscrunch');?></a>
                                            </span>
                                            <?php } 
                    ...
                    <div class="spnc-filter">
                        <article class="spnc-post">
                            ...
                            <div class="spnc-post-content">
                                ...
                                <?php if($show_read=='on') { ?>
                                    <div class="spnc-entry-content">
                                        <a href="<?php the_permalink();?>" class="spnc-more-link" title="<?php esc_attr_e('Read More','newscrunch'); ?>"><?php echo esc_html__('Read More', 'newscrunch' );?></a>
                                    </div>
                                <?php }  ?>
                            </div>
                    </article>
