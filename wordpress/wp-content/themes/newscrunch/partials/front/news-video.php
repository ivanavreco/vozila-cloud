										...
										<div class="spnc-post-wrapper">
											<div class="spnc-video-popup">
												<?php if($newscrunch_array_video_url[$i] != ''): ?>
													<a href="<?php	if(str_contains($newscrunch_array_video_url[$i], '&')) { echo strstr($newscrunch_array_video_url[$i], '&', true); } else { echo $newscrunch_array_video_url[$i]; } ?>" class="spncOpenVideo popup-youtube1" title="<?php esc_attr_e('Video Popup','newscrunch'); ?>"><i class="fas fa-solid fa-play"></i></a>
												<?php endif; ?>
	                                        </div>
											<header class="entry-header">
												...
												<h3 class="spnc-entry-title">
													<a href="<?php echo esc_url(get_permalink($array[$i])); ?>" title="<?php echo esc_attr(get_the_title($array[$i]));?>"><?php echo esc_html(get_the_title($array[$i]));?></a>
												</h3>
											</header>
											<?php if($newscrunch_hide_show_featured_video_meta == true) { ?>
										...
										<div class="spnc-post-content">
											<div class="spnc-content-wrapper">
												<div class="spnc-post-wrapper">
													<div class="spnc-video-popup">
														<?php if($newscrunch_array_video_url[$i] != ''): ?>
															<a href="<?php	if(str_contains($newscrunch_array_video_url[$i], '&')) { echo strstr($newscrunch_array_video_url[$i], '&', true); } else { echo $newscrunch_array_video_url[$i]; } ?>" class="spncOpenVideo popup-youtube2" title="<?php esc_attr_e('Video Popup','newscrunch'); ?>"><i class="fas fa-solid fa-play"></i></a>
														<?php endif; ?>
	                                              	</div>
													<header class="entry-header">
														<?php if($newscrunch_hide_show_featured_video_meta == true) { ?>
										...
										<div class="spnc-post-content">
											<div class="spnc-content-wrapper">
												<div class="spnc-post-wrapper">
													<div class="spnc-video-popup">
														<?php if($newscrunch_array_video_url[$i] != ''): ?>
															<a href="<?php	if(str_contains($newscrunch_array_video_url[$i], '&')) { echo strstr($newscrunch_array_video_url[$i], '&', true); } else { echo $newscrunch_array_video_url[$i]; } ?>" class="spncOpenVideo popup-youtube3" title="<?php esc_attr_e('Video Popup','newscrunch'); ?>"><i class="fas fa-solid fa-play"></i></a>
														<?php endif; ?>
		                                          	</div>
													<header class="entry-header">
														<?php if($newscrunch_hide_show_featured_video_meta == true) { ?>
