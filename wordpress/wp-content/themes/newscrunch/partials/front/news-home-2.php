<section class="spnc-page-section-space page_widget2 spnc-blog-2">
    <div class="spnc-container">
        <div class="spnc-row">
            <?php if(get_theme_mod('page_widget2_sidebar_layout','right')=='left') { ?>
            ...
            if(get_theme_mod('page_widget2_sidebar_layout','right')=='right' || get_theme_mod('page_widget2_sidebar_layout','right')=='left'):        
            ...
            <?php if(get_theme_mod('page_widget2_sidebar_layout','right')=='right') { ?>
            <div class="spnc-col-9">
                <div itemscope itemtype="https://schema.org/WPSideBar" class="spnc-sidebar spnc-sticky-sidebar" id="spnc-sidebar-fixed">
                    <div class="right-sidebar">
                        <?php
