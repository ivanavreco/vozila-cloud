...
if (!function_exists('newscrunch_breadcrumbs')):
	...
	function newscrunch_breadcrumbs() { 
		...
		$breadcrumb='';
		$newscrunch_breadcrumb_type = get_theme_mod('newscrunch_breadcrumb_type','yoast');
				...
				<div class="spnc-container">
					...
					if(get_theme_mod('bredcrumb_alignment','parallel')=='parallel'){ 
				    	...
				    	if(get_theme_mod('bredcrumb_position','page_header')=='page_header'):   
				    			...
				    			if(($breadcrumb_enable_disable == true) && ((($newscrunch_breadcrumb_type == 'yoast') && ( function_exists('yoast_breadcrumb') )) || (($newscrunch_breadcrumb_type == 'rankmath') && ( class_exists('RankMath') ) ) ||(($newscrunch_breadcrumb_type == 'navxt') && (class_exists('breadcrumb_navxt')))))
				    			{
				    				$breadcrumb_column='8';
				    			}
				    			else
				    ...
				    elseif(get_theme_mod('bredcrumb_alignment','parallel')=='parallelr'){
				    	...
				    	if(get_theme_mod('bredcrumb_position','page_header')=='page_header'):
				    		if( ($breadcrumb)||($newscrunch_breadcrumb_type == 'rankmath')||($newscrunch_breadcrumb_type == 'navxt') ){ $col='8';}else{ $col='1';}
