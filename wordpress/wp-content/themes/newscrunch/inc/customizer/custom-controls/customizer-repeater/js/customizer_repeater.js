...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        // if(jQuery("#newscrunch_social_limit").val()==5)
        // {
        //    jQuery(".customizer_newscrunch_social_upgrade_to_pro").show();
        //     return false;
        // }
        // else
        // {
        //    var total_social_sections=parseInt(jQuery("#newscrunch_social_limit").val())+1;
        //    jQuery("#newscrunch_social_limit").val(total_social_sections)
        //    if(jQuery("#newscrunch_social_limit").val()>5)
        // {
        //    jQuery(".customizer_newscrunch_social_upgrade_to_pro").hide();
        // }
        // }
    ...
    //     var total_icon= parseInt(jQuery("#newscrunch_social_limit").val())-1;
    //    jQuery("#newscrunch_social_limit").val(total_icon);
    ...
    // theme_conrols.on('paste', '.customizer-repeater-link-control', function () {
    //     customizer_repeater_refresh_general_control_values();
    // });
